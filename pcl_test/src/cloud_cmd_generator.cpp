...
private:
	...
	std::vector<std::vector<double> > pos_deisre;
...
// 	// 	int distance=(pos_deisre[i][0]-pos_now[0])*(pos_deisre[i][0]-pos_now[0])+(pos_deisre[i][1]-pos_now[1])*(pos_deisre[i][1]-pos_now[1]);
// 	// 	while(distance<0.1){
